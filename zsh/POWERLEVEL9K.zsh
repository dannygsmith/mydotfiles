...
POWERLEVEL9K_DATE_VISUAL_IDENTIFIER_COLOR="green"
POWERLEVEL9K_TIME_VISUAL_IDENTIFIER_COLOR="green"
POWERLEVEL9K_DATE_FORMAT="%D{%m/%d %H:%M}"	# Output time, date, and a symbol  from the "Awesome
POWERLEVEL9K_TIME_FORMAT="%T{%H:%M}"	# Output time, date, and a symbol  from the "Awesome
															# Powerline Font" set
#date "%Y/%m/%d% %H:%M:%S"
